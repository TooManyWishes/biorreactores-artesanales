...
from geometry_setup_wood import create_bioreactor_geometry
from material_properties_wood import MaterialProperties
...
class BioreactorThermalModel:
    ...
    def solve_transient(self, save_interval=3600):
        ...
        filename = os.path.join(self.results_dir, f"bioreactor_{self.bioreactor_type}_evaporation_wood.xdmf")
    ...
    def save_statistics(self, times, T_max, T_min, T_avg, q_gen, q_evap, moisture):
        ...
        filename = os.path.join(self.results_dir, f"stats_{self.bioreactor_type}_evaporation_wood.json")
