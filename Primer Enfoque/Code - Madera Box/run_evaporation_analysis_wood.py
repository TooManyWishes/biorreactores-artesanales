"""
run_evaporation_analysis_wood.py
...
# Importar el modelo
from main_thermal_model_wood import run_evaporation_simulation
from visualization_wood import BioreactorVisualizer
...
def main():
    ...
    try:
        ...
        print("  - Datos 3D: bioreactor_box_evaporation_wood.xdmf")
        print("  - Estadísticas: stats_box_evaporation_wood.json")
        print("  - Reporte: reporte_evaporacion_wood.txt")
...
def create_evaporation_report(model, times, T_max, T_min, T_avg):
    ...
    # Cargar estadísticas
    import json
    stats_file = os.path.join(model.results_dir, f"stats_{model.bioreactor_type}_evaporation_wood.json")
    ...
    # Guardar reporte
    filename = os.path.join(model.results_dir, "reporte_evaporacion_wood.txt")
