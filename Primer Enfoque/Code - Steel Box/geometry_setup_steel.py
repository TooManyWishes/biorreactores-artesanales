...
class BioreactorGeometry:
    ...
    def create_material_markers(self):
        """
        Crea marcadores para distinguir entre acero (paredes) y cacao (interior)

        """
        print("🏷️ Marcando regiones de materiales (acero + cacao)...")
        ...
        steel_cells = np.sum(markers == 1)
        
        print(f"✅ Regiones marcadas:")
        print(f"   - Celdas de acero: {steel_cells}")
    ...
    def get_volume_info(self):
        ...
        if self.bioreactor_type == 'box':
            ...
            print(f"   Volumen de acero: {V_acero:.4f} m³")
