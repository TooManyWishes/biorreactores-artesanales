"""
run_evaporation_analysis_steel.py
...
# Importar el modelo
from main_thermal_model_steel import run_evaporation_simulation
from visualization_steel import BioreactorVisualizer
...
def main():
    ...
    try:
        ...
        print("  - Datos 3D: bioreactor_box_evaporation_steel.xdmf")
        print("  - Estadísticas: stats_box_evaporation_steel.json")
...
def create_evaporation_report(model, times, T_max, T_min, T_avg):
    ...
    # Cargar estadísticas
    import json
    stats_file = os.path.join(model.results_dir, f"stats_{model.bioreactor_type}_evaporation_steel.json")
    ...
    report_lines.append("- Tipo: Caja de acero 85×90×74 cm")
