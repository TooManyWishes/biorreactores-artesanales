...
class BioreactorGeometry:
    ...
    def _setup_box_dimensions(self):
        ...
        # Espesor de las paredes (plástico)
    ...
    def create_material_markers(self):
        """
        Crea marcadores para distinguir entre plástico (paredes) y cacao (interior)

        """
        print("🏷️ Marcando regiones de materiales (plástico + cacao)...")
        ...
        # Marcar celdas: 1 = plástico, 2 = cacao
        ...
        plastic_cells = np.sum(markers == 1)
        
        print(f"✅ Regiones marcadas:")
        print(f"   - Celdas de plástico: {plastic_cells}")
