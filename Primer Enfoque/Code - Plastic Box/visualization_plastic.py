...
class BioreactorVisualizer:
    ...
    def plot_2d_evolution(self, stats_file='stats_box_evaporation_plastic.json'):
        """Visualización 2D"""
        ...
        # Guardar
        output_file = os.path.join(self.results_dir, 'thermal_evolution_2d_plastic.png')
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"📊 Gráfico 2D guardado: {output_file}")
        
        plt.show()
    
    def visualize_3d_fields(self, xdmf_file='bioreactor_box_evaporation_plastic.xdmf', 
                           time_step=-1):
        """
        ...
        # Guardar captura
        output_file = os.path.join(self.results_dir, 'thermal_3d_view_plastic.png')
        plotter.screenshot(output_file)
        print(f"📸 Vista 3D guardada: {output_file}")
    
    def create_animation_3d(self, xdmf_file='bioreactor_box_evaporation_plastic.xdmf',
                           output_gif='thermal_animation_plastic.gif'):
        """
    ...
    def plot_3d_mesh_structure(self):
        ...
        plotter.add_mesh(grid, scalars='Material', 
                        cmap=['white', self.colors['plastic'], self.colors['cacao']],
                        show_edges=True, edge_color='gray',
                        opacity=0.8)
    ...
    def create_summary_report(self, stats_file='stats_box_evaporation_plastic.json'):
        ...
        # Información clave
        info_text = f"""
        Biorreactor: Caja de plástico 85×90×74 cm
        ...
        plt.tight_layout()
        output_file = os.path.join(self.results_dir, 'summary_report_plastic.png')
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
