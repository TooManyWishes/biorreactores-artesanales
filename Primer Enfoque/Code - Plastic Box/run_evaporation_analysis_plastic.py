"""
run_evaporation_analysis_plastic.py
...
# Importar el modelo
from main_thermal_model_plastic import run_evaporation_simulation
from visualization_plastic import BioreactorVisualizer
...
def main():
    ...
    try:
        ...
        print("  - Datos 3D: bioreactor_box_evaporation_plastic.xdmf")
        print("  - Estadísticas: stats_box_evaporation_plastic.json")
        print("  - Reporte: reporte_evaporacion_plastico.txt")
...
def create_evaporation_report(model, times, T_max, T_min, T_avg):
    ...
    # Cargar estadísticas
    import json
    stats_file = os.path.join(model.results_dir, f"stats_{model.bioreactor_type}_evaporation_plastic.json")
    ...
    report_lines.append("- Tipo: Caja de plástico 85×90×74 cm")
