...
class HexagonalMaterialProperties:
    ...
    def __init__(self):
        ...
        self.ventilation = {
            ...
            'enhanced_h_conv': 80.0,  
            'drum_convection_factor': 0.5, 
            
            # EVAPORACIÓN OPTIMIZADA
            'L_vap': 2.257e6,
            'vapor_diffusivity': 2.5e-5, 
            'mass_transfer_coeff_natural': 0.001, 
            'lewis_number': 0.865,
            
            # FACTORES DE MEJORA AUMENTADOS
            'buoyancy_enhancement': 0.9, 
            'rotation_mixing_factor': 1.5, 
            'daily_rotation_bonus': 1.15, 
            'geometry_bonus': 1.2,  
        }
        ...
        self.fermentation_control = {
            ...
            'heat_reduction_factor': 1,  # SIGNIFICATIVAMENTE REDUCIDO
            'evaporative_cooling_feedback': True,
            'rotation_stress_factor': 1.0,
            'no_death_mode': True,
            'temperature_safety_mode': True,  
            'max_heat_generation': 999.0,   LÍMITE [W/m³]
        }
    ...
    def get_evaporative_cooling(self, T, t, rotation_factor=1.0):
        ...
        # CONVECCIÓN (factor clave para enfriamiento)
        ...
        # Área específica 
        d_bean = 0.01
        a_specific = 8 * (1 - self.cacao['porosity']) / d_bean 
    ...
    def _get_controlled_heat_profile(self, t):
        ...
        if t_hours < 12:
            ...
            # Declive controlado
            q = 320.0 - (320.0 - 220.0) * ((t_hours - 84.0) / 84.0)
        else:
            # Actividad residual
            q = 180.0
    ...
    def create_hexagonal_material_functions(self, domain, material_markers):
        ...
        # Densidad = 300 kg / 0.517 m³ = 580 kg/m³
