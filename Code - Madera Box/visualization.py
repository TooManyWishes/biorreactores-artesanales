...
class BioreactorVisualizer:
    ...
    def plot_2d_evolution(self, stats_file='stats_box_evaporation.json'):
        """Visualización 2D"""
        ...
        # Guardar
        output_file = os.path.join(self.results_dir, 'thermal_evolution_2d.png')
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
        print(f"📊 Gráfico 2D guardado: {output_file}")
        
        plt.show()
    
    def visualize_3d_fields(self, xdmf_file='bioreactor_box_evaporation.xdmf', 
                           time_step=-1):
        """
        ...
        # Guardar captura
        output_file = os.path.join(self.results_dir, 'thermal_3d_view.png')
        plotter.screenshot(output_file)
        print(f"📸 Vista 3D guardada: {output_file}")
    
    def create_animation_3d(self, xdmf_file='bioreactor_box_evaporation.xdmf',
                           output_gif='thermal_animation.gif'):
        """
    ...
    def create_summary_report(self, stats_file='stats_box_evaporation.json'):
        ...
        plt.tight_layout()
        output_file = os.path.join(self.results_dir, 'summary_report.png')
        plt.savefig(output_file, dpi=300, bbox_inches='tight')
